...
console.log(books)
console.log("Harry Potter y la piedra filosofal", isBookRead(books, "Harry Potter y la piedra filosofal"))
...
console.log("El señor de los anillos", isBookRead(books, "El señor de los anillos"))